...
\begin{frame}{Module Outline}
    \begin{itemize}[<+->]
        ...
        \item E-R Model
        \begin{itemize}
            \item[$\triangleright$] Entity and Entity Set
            \item[$\triangleright$] Relationship
            \item[$\triangleright$] Cardinality
            \item[$\triangleright$] Attributes
            \item[$\triangleright$] Weak Entity Sets
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Role of Abstraction}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] Storage (STM) limitations of human brain - an individual can simultaneously comprehend of the order of seven, plus or minus two chunks of information
            \item[$\triangleright$] Speed limitations of human brain - it takes the mind about five seconds to accept a new chunk of information
        \end{itemize}
...
\begin{frame}{Design Approach}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] Planning
            \item[$\triangleright$] System Definition
        \end{itemize}
        \item Database Designing: Use a modeling framework to create abstraction of the real world
        \begin{itemize}
            \item[$\triangleright$] Logical Model
            \item[$\triangleright$] Physical Model
        \end{itemize}
        \item Implementation
        \begin{itemize}
            \item[$\triangleright$] Data Conversion and Loading
        \end{itemize}
        \item Testing
    \end{itemize}
\end{frame}
...
\begin{frame}{Design Approach (2): Database Designing}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] \textbf{Business Decision}: What attributes should we record in the database?
            \item[$\triangleright$] \textbf{Computer Science Decision}: What relation schema should we have and how should the attributes be distributed among the various relation schema?
        \end{itemize}
...
\begin{frame}{Design Approach (3): Database Designing: Logical Model}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            ...
            \item[$\triangleright$] \textbf{Entity}: A distinguishable 'thing' or 'object' in the enterprise
            \begin{itemize}
                \item[$\circ$] Described by a set of attributes
            \end{itemize}
            \item[$\triangleright$] \textbf{Relationship}: An association among multiple entities
            \item[$\triangleright$] Represented by an Entity-Relationship or ER Diagram
        \end{itemize}
...
\begin{frame}{ER Model: Database Modeling}
    \begin{block}{Overview}
        \begin{itemize}[<+->]
            ...
            \begin{itemize}
                \item[$\triangleright$] Attributes
                \item[$\triangleright$] Entity sets
                \item[$\triangleright$] Relationship sets
            \end{itemize}
...
\begin{frame}{Attributes}
    \begin{block}{Definition}
        \begin{itemize}[<+->]
            ...
            \begin{itemize}
                \item[$\triangleright$] Simple and Composite attributes
                \item[$\triangleright$] Single-valued and Multivalued attributes
                \begin{itemize}
                    \item[$\circ$] Example: Multivalued attribute: phone numbers
                \end{itemize}
                \item[$\triangleright$] Derived attributes
                \begin{itemize}
                    \item[$\circ$] Can be computed from other attributes
                    \item[$\circ$] Example: age, given date of birth
                \end{itemize}
            \end{itemize}
...
\begin{frame}{Entity Sets}
    \begin{block}{Definition}
        \begin{itemize}[<+->]
            ...
            \begin{itemize}
                \item[$\triangleright$] Example: specific person, company, event, plant
            \end{itemize}
            \item An entity set is a set of entities of the same type that share the same properties.
            \begin{itemize}
                \item[$\triangleright$] Example: set of all persons, companies, trees, holidays
            \end{itemize}
            ...
            \begin{itemize}
                \item[$\triangleright$] Example: \texttt{instructor = (ID, name, street, city, salary)}, \texttt{course = (course\_id, title, credits)}
                \item[$\triangleright$] A subset of the attributes form a primary key of the entity set; that is, uniquely identifying each member of the set.
                \item[$\triangleright$] Primary key of an entity set is represented by underlining it.
            \end{itemize}
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}{Relationship Set (4): Degree}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] involves two entity sets (or degree two).
            \item[$\triangleright$] most relationship sets in a database system are binary.
        \end{itemize}
        \item Relationships between more than two entity sets are rare. Most relationships are binary
        \begin{itemize}
            \item[$\triangleright$] Example: students work on research projects under the guidance of an instructor.
            \item[$\triangleright$] relationship \texttt{proj\_guide} is a ternary relationship between \texttt{instructor}, \texttt{student}, and \texttt{project}
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Attributes (3): Redundant}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] \texttt{instructor}, with attributes: ID, name, dept\_name, salary
            \item[$\triangleright$] \texttt{department}, with attributes: dept\_name, building, budget
        \end{itemize}
...
\begin{frame}{Mapping Cardinality Constraints}
    \begin{block}{Overview}
        \begin{itemize}[<+->]
            ...
            \begin{itemize}
                \item[$\triangleright$] One to one
                \item[$\triangleright$] One to many
                \item[$\triangleright$] Many to one
                \item[$\triangleright$] Many to many
            \end{itemize}
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}{Weak Entity Sets}
    ...
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] A strong entity set is an entity set that contains sufficient attributes to uniquely identify all its entities
            \item[$\triangleright$] In other words, a primary key exists for a strong entity set
            \item[$\triangleright$] Primary key of a strong entity set is represented by underlining it
        \end{itemize}
        \item Weak entity set
        \begin{itemize}
            \item[$\triangleright$] A weak entity set is an entity set that does not contain sufficient attributes to uniquely identify its entities
            \item[$\triangleright$] In other words, a primary key does not exist for a weak entity set
            \item[$\triangleright$] However, it contains a partial key called as a discriminator
            \item[$\triangleright$] Discriminator can identify a group of entities from the entity set
            \item[$\triangleright$] Discriminator is represented by underlining with a dashed line
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Weak Entity Sets (2)}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] The combination of discriminator and primary key of the strong entity set makes it possible to uniquely identify all entities of the weak entity set
            \item[$\triangleright$] Thus, this combination serves as a primary key for the weak entity set.
            \item[$\triangleright$] Clearly, this primary key is not formed by the weak entity set completely.
            \item[$\triangleright$] Primary Key of Weak Entity Set = Its own discriminator + Primary Key of Strong Entity Set
        \end{itemize}
...
\begin{frame}{Weak Entity Sets (3): Example}
    \begin{exampleblock}{Example}
        \begin{itemize}[<+->]
            ...
            \begin{itemize}
                \item[$\triangleright$] First, building no is required to identify the particular building
                \item[$\triangleright$] Second, door no of the apartment is required to uniquely identify the apartment
                \item[$\triangleright$] Primary key of Apartment = Primary key of Building + Its own discriminator = building no + door no
            \end{itemize}
        \end{itemize}
    \end{exampleblock}
\end{frame}
