...
\begin{frame}{Cardinality Constraints}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] A student is associated with at most one instructor via the relationship advisor
            \item[$\triangleright$] An instructor is associated with at most one student via the relationship advisor
        \end{itemize}
    \end{itemize}
    \begin{center}
...
\begin{frame}{Total and Partial Participation}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] participation of student in advisor relation is total
            \item[$\triangleright$] every student must have an associated instructor
        \end{itemize}
        \item \textbf{Partial participation}: some entities may not participate in any relationship in the relationship set
        \begin{itemize}
            \item[$\triangleright$] Example: participation of instructor in advisor is partial
        \end{itemize}
    \end{itemize}
    \begin{center}
...
\begin{frame}{Representing Relationship Sets}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] \texttt{advisor = (s\_id, i\_id)}
        \end{itemize}
    \end{itemize}
    \begin{center}
...
\begin{frame}{Representation of Entity Sets with Composite Attributes}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] Prefix omitted if there is no ambiguity (\texttt{name\_first\_name} could be \texttt{first\_name})
        \end{itemize}
        \item Ignoring multivalued attributes, extended \texttt{instructor} schema is
        \begin{itemize}
            \item[$\triangleright$] \texttt{instructor(ID, first\_name, middle\_initial, last\_name, street\_number, street\_name, apt\_number, city, state, zip\_code, date\_of\_birth)}
        \end{itemize}
    \end{itemize}
    \begin{center}
