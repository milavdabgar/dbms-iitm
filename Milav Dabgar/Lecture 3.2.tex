...
where P
            ...
            \textbf{as follows:}
            \begin{itemize}
                \item[$\triangleright$] \texttt{Ai} can be replaced by a subquery that generates a single value
                \item[$\triangleright$] \texttt{ri} can be replaced by any valid subquery
                \item[$\triangleright$] \texttt{P} can be replaced with an expression of the form:
                \item[$\triangleright$] \texttt{B <operation> (subquery)}
                \item[$\triangleright$] where \texttt{B} is an attribute and \texttt{<operation>} to be defined later
            \end{itemize}
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}{Subqueries in the Where Clause}
    \begin{block}{Usage}
        \begin{itemize}[<+->]
            ...
            \begin{itemize}
                \item[$\triangleright$] For set membership
                \item[$\triangleright$] For set comparisons
                \item[$\triangleright$] For set cardinality
            \end{itemize}
        \end{itemize}
    \end{block}
\end{frame}
