...
\begin{frame}[fragile]{Levels of Abstraction}
    \begin{block}{Physical and Logical Levels}
        \begin{itemize}[<+->]
    ...
    \begin{exampleblock}{Example: Logical Level}<3->
\begin{verbatim}
...
\begin{frame}{Schema and Instances}
    \begin{block}{Physical Data Independence}
        \begin{itemize}[<+->]
            \item \textbf{Definition:} The ability to modify the physical schema without changing the logical schema
...
\begin{frame}{Data Models}
    ...
    \uncover<2->{
        \begin{itemize}[<+->]
            \item \textbf{Relational model} (we focus in this course)
            \item \textbf{Entity-Relationship data model} (mainly for database design)
            \item \textbf{Object-based data models} (Object-oriented and Object-relational)
            \item \textbf{Other older models}
            \begin{itemize}
                \item Network model
                \item Hierarchical model
            \end{itemize}
            \item \textbf{Recent models for Semi-structured or Unstructured data}
            \begin{itemize}
    ...
    \uncover<3->{
        \begin{itemize}[<+->]
            ...
            \begin{itemize}
                ...
                \item Integrity constraints (e.g., Primary key: ID uniquely identifies instructors)
