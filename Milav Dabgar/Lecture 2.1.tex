...
\begin{frame}{Attribute Types}
    \begin{exampleblock}{Example Relation}
        Consider \texttt{Students = (Roll\#, First Name, Last Name, DoB, Passport\#, Aadhaar\#, Department)} relation
    \end{exampleblock}
...
\begin{frame}{Relational Query Languages}
    \begin{block}{Procedural viz-a-viz Non-procedural or Declarative Paradigms}
        \begin{itemize}[<+->]
