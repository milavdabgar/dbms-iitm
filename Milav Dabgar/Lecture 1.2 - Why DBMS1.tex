...
\begin{frame}{Data Management: Electronic}
    \begin{exampleblock}{Growth with Technology}
...
\begin{frame}{Why leave filesystems?}
    ...
    \uncover<7->{
        \vspace{0.5em}
        \begin{alertblock}{Database Management Systems}
    ...
    \begin{center}
        \resizebox{\textwidth}{!}{
            \begin{tikzpicture}[
                ...
                node distance=5mm,
                event/.style={rectangle, draw=MidnightBlue!80, fill=MidnightBlue!5, rounded corners, thick, text centered, text width=3cm, minimum height=3.5cm, drop shadow, on chain},
                year/.style={font=\bfseries, text=MidnightBlue, align=center, inner sep=2pt, fill=white}
            ]
            ...
            \node[year, above=2mm of 50s] {1950s - 60s};
            
            \node[event] (70s) {
                \begin{itemize}
                    \item Hard disks (direct access)
                    \item Network \& Hierarchical models
                    \item Ted Codd (Relational model)
                \end{itemize}
            };
            \node[year, above=2mm of 70s] {Late 60s - 70s};
            
            \node[event] (80s) {
                \begin{itemize}
                    \item SQL industrial standard
                    \item Parallel \& distributed DBs
                    \item Object-oriented DBs
                \end{itemize}
            };
            \node[year, above=2mm of 80s] {1980s};
            ...
            \node[year, above=2mm of 90s] {1990s};
            
            % Arrows
            \draw[->, thick, MidnightBlue!50] (50s) -- (70s);
            \draw[->, thick, MidnightBlue!50] (70s) -- (80s);
            \draw[->, thick, MidnightBlue!50] (80s) -- (90s);
...
\begin{frame}{History of Database Systems (2)}
    \begin{center}
        \resizebox{0.7\textwidth}{!}{
            \begin{tikzpicture}[
                start chain=going right,
                node distance=10mm,
                event/.style={rectangle, draw=MidnightBlue!80, fill=MidnightBlue!5, rounded corners, thick, text centered, text width=4cm, minimum height=3cm, drop shadow, on chain},
                year/.style={font=\bfseries, text=MidnightBlue, align=center, inner sep=2pt, fill=white}
            ]
            ...
            \node[year, above=2mm of early00s] {Early 2000s};
            
            \node[event] (late00s) {
                \begin{itemize}
                    \item Giant data storage systems
                    \begin{itemize}
            ...
            \node[year, above=2mm of late00s] {Later 2000s};
            
            % Arrows
            \draw[->, thick, MidnightBlue!50] (early00s) -- (late00s);
