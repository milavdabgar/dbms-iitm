...
\begin{frame}{Normalization or Schema Refinement}
    \begin{itemize}
        ...
        \begin{itemize}
            \item Eliminating redundant (useless) data
            \item Ensuring data dependencies make sense, that is, data is logically stored
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Desirable Properties of Decomposition}
    \begin{itemize}
        ...
        \begin{itemize}
            \item It should be possible to reconstruct the original table
        \end{itemize}
        \item \textbf{Dependency Preserving Property}
        \begin{itemize}
            \item No functional dependency (or other constraints should get violated)
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{1NF (3): Possible Redundancy}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item $\Rightarrow X$ can duplicate
            \item $\Rightarrow$ Corresponding $Y$ value would duplicate also.
        \end{itemize}
    \end{itemize}
    \vspace{0.5em}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item $\Rightarrow$ Corresponding $Y$ value may or may not duplicate.
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{2NF: Second Normal Form}
    \begin{itemize}
        ...
        \begin{itemize}
            \item $R$ is in 1NF and
            \item $R$ contains no Partial Dependency
        \end{itemize}
    \end{itemize}
    \vspace{0.5em}
...
\begin{frame}{3NF: Third Normal Form}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item $R$ should be in 2NF
            \item $R$ should not contain transitive dependencies (OR, Every non-prime attribute of $R$ is non-transitively dependent on every key of $R$)
        \end{itemize}
        ...
        \begin{itemize}
            \item $X$ contains $A$ (that is, $A$ is a subset of $X$, meaning $X \rightarrow A$ is trivial functional dependency), or
            \item $X$ is a superkey, or
            \item Every element of $A - X$, the set difference between $A$ and $X$, is a prime attribute (i.e., each attribute in $A - X$ is contained in some candidate key)
        \end{itemize}
...
\begin{frame}{3NF (3): Transitive Dependency}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \texttt{\{Book\} $\rightarrow$ \{Author\}}
            \item \texttt{\{Author\}} does not $\rightarrow$ \texttt{\{Book\}}
            \item \texttt{\{Author\} $\rightarrow$ \{Author Nationality\}}
        \end{itemize}
