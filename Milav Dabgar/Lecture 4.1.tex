...
\begin{frame}{Relational Algebra}
    \begin{block}{Overview}
        \begin{itemize}[<+->]
            ...
            \begin{itemize}
                \item[$\triangleright$] select: $\sigma$
                \item[$\triangleright$] project: $\Pi$
                \item[$\triangleright$] union: $\cup$
                \item[$\triangleright$] set difference: $-$
                \item[$\triangleright$] Cartesian product: $\times$
                \item[$\triangleright$] rename: $\rho$
            \end{itemize}
...
\begin{frame}{Difference Operation}
    \begin{block}{Definition}
        \begin{itemize}[<+->]
            ...
            \begin{itemize}
                \item[$\triangleright$] $r$ and $s$ must have the same arity
                \item[$\triangleright$] attribute domains of $r$ and $s$ must be compatible
            \end{itemize}
