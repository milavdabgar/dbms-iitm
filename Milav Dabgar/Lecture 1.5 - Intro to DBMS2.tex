...
\begin{frame}{Design Approaches}
    \begin{itemize}
        \item Need to come up with a methodology to ensure that each relations in the database is good
        \item Two ways of doing so:
        \begin{itemize}
...
\begin{frame}{Object-Relational Data Models}
    \begin{itemize}
        \item Relational model: flat, atomic values
        \item Object Relational Data Models
        \begin{itemize}
...
\begin{frame}{XML: Extensible Markup Language}
    \begin{itemize}
        ...
        \item XML has become the basis for all new generation data interchange formats
...
\begin{frame}{Storage Management}
    \begin{itemize}
        \item Storage manager is a program module that provides the interface between the low-level data stored in the database and the application programs and queries submitted to the system
        \item The storage manager is responsible for the following tasks:
        \begin{itemize}
...
\begin{frame}{Query Processing (2)}
    \begin{itemize}
        ...
        \end{itemize}
        \item Cost difference between a good and a bad way of evaluating a query can be enormous
...
\begin{frame}{Transaction Management}
    \begin{itemize}
        \item What if the system fails?
        \item What if more than one user is concurrently updating the same data?
