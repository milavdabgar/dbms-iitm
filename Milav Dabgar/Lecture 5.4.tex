...
\begin{frame}{Attribute Set Closure}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            ...
            \item[$\triangleright$] b) result = $ABCG$ \quad ($A \rightarrow C$ and $A \rightarrow B$)
            \item[$\triangleright$] c) result = $ABCGH$ \quad ($CG \rightarrow H$ and $CG \subseteq AGBC$)
            \item[$\triangleright$] d) result = $ABCGHI$ \quad ($CG \rightarrow I$ and $CG \subseteq AGBCH$)
        \end{itemize}
...
\begin{frame}{Extraneous Attributes}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] $B$ is extraneous in $AB \rightarrow C$ because $\{A \rightarrow C, AB \rightarrow C\}$ logically implies $A \rightarrow C$ (that is, the result of dropping $B$ from $AB \rightarrow C$).
            \item[$\triangleright$] $A^+ = AC$ in $\{A \rightarrow C, AB \rightarrow C\}$
        \end{itemize}
        \item Example: Given $F = \{A \rightarrow C, AB \rightarrow CD\}$
        \begin{itemize}
            \item[$\triangleright$] $C$ is extraneous in $AB \rightarrow CD$ since $AB \rightarrow C$ can be inferred even after deleting $C \circ (AB)^+ = ABCD$ in $\{A \rightarrow C, AB \rightarrow D\}$
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Extraneous Attributes (2): Tests}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] a) Compute $(\{\alpha\} - A)^+$ using the dependencies in $F$
            \item[$\triangleright$] b) Check that $(\{\alpha\} - A)^+$ contains $\beta$; if it does, $A$ is extraneous in $\alpha$
        \end{itemize}
        \item To test if attribute $A \in \beta$ is extraneous in $\beta$
        \begin{itemize}
            \item[$\triangleright$] a) Compute $\alpha^+$ using only the dependencies in $F' = (F - \{\alpha \rightarrow \beta\}) \cup \{\alpha \rightarrow (\beta - A)\}$,
            \item[$\triangleright$] b) Check that $\alpha^+$ contains $A$; if it does, $A$ is extraneous in $\beta$
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Equivalence of Sets of Functional Dependencies}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] \textbf{$F$ covers $G$}: Means that all functional dependency of $G$ are logically members of functional dependency set $F \Rightarrow F^+ \supseteq G$.
            \item[$\triangleright$] \textbf{$G$ covers $F$}: Means that all functional dependency of $F$ are logically members of functional dependency set $G \Rightarrow G^+ \supseteq F$.
        \end{itemize}
    \end{itemize}
    \uncover<5->{
    \begin{center}
...
\begin{frame}{Canonical Cover}
    ...
    \end{itemize}
    \uncover<3->{
    \begin{block}{Canonical Cover}
        A \textbf{Canonical Cover} for $F$ is a set of dependencies $F_c$ such that ALL the following properties are satisfied:
        \begin{itemize}
            \item $F^+ = F_c^+$. Or,
            \begin{itemize}
                \item $F$ logically implies all dependencies in $F_c$
                \item $F_c$ logically implies all dependencies in $F$
            \end{itemize}
...
\begin{frame}{Canonical Cover (3): RHS}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] (1) $A \rightarrow CD \Rightarrow A \rightarrow C$ and $A \rightarrow D$
            \item[$\triangleright$] (2) $A \rightarrow B, B \rightarrow C \Rightarrow A \rightarrow C$
            \item[$\triangleright$] $A^+ = ABCD$
        \end{itemize}
        \item $\{A \rightarrow B, B \rightarrow C, A \rightarrow D\} \Rightarrow \{A \rightarrow B, B \rightarrow C, A \rightarrow CD\}$
        \begin{itemize}
            \item[$\triangleright$] $A \rightarrow B, B \rightarrow C \Rightarrow A \rightarrow C$
            \item[$\triangleright$] $A \rightarrow C, A \rightarrow D \Rightarrow A \rightarrow CD$
            \item[$\triangleright$] $A^+ = ABCD$
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Canonical Cover (4): LHS}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] $A \rightarrow B, B \rightarrow C \Rightarrow A \rightarrow C \Rightarrow A \rightarrow AC$
            \item[$\triangleright$] $A \rightarrow AC, AC \rightarrow D \Rightarrow A \rightarrow D$
            \item[$\triangleright$] $A^+ = ABCD$
        \end{itemize}
        \item $\{A \rightarrow B, B \rightarrow C, A \rightarrow D\} \Rightarrow \{A \rightarrow B, B \rightarrow C, AC \rightarrow D\}$
        \begin{itemize}
            \item[$\triangleright$] $A \rightarrow D \Rightarrow AC \rightarrow D$
            \item[$\triangleright$] $AC^+ = ABCD$
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Canonical Cover (6): Example}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] Check if the result of deleting $A$ from $AB \rightarrow C$ is implied by the other dependencies
            \item[$\triangleright$] $\triangleright$ Yes: in fact, $B \rightarrow C$ is already present!
        \end{itemize}
        \item Set is now $\{A \rightarrow BC, B \rightarrow C\}$
        \item $C$ is extraneous in $A \rightarrow BC$
        \begin{itemize}
            \item[$\triangleright$] Check if $A \rightarrow C$ is logically implied by $A \rightarrow B$ and the other dependencies
            \item[$\triangleright$] $\triangleright$ Yes: using transitivity on $A \rightarrow B$ and $B \rightarrow C$.
            \item[$\triangleright$] Can use attribute closure of $A$ in more complex cases
        \end{itemize}
...
\begin{frame}{Practice Problems on Functional Dependencies}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] i) Check: $BCD \rightarrow H$
            \item[$\triangleright$] ii) Check: $AED \rightarrow C$
        \end{itemize}
        \item b) For: $AB \rightarrow CD, AF \rightarrow D, DE \rightarrow F, C \rightarrow G, F \rightarrow E, G \rightarrow A$
        \begin{itemize}
            \item[$\triangleright$] i) Check: $CF \rightarrow DF$
            \item[$\triangleright$] ii) Check: $BG \rightarrow E$
            \item[$\triangleright$] iii) Check: $AF \rightarrow G$
            \item[$\triangleright$] iv) Check: $AB \rightarrow EF$
        \end{itemize}
        \item c) For: $A \rightarrow BC, B \rightarrow E, CD \rightarrow EF$
        \begin{itemize}
            \item[$\triangleright$] i) Check: $AD \rightarrow F$
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{Practice Problems on Functional Dependencies (5)}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}
            \item[$\triangleright$] i) $F: A \rightarrow C, AC \rightarrow D, E \rightarrow AD, E \rightarrow H$
            \item[$\triangleright$] ii) $G: A \rightarrow CD, E \rightarrow AH$
        \end{itemize}
        \item b) Consider the two sets $P$ and $Q$ with their FDs as below:
        \begin{itemize}
            \item[$\triangleright$] i) $P: A \rightarrow B, AB \rightarrow C, D \rightarrow ACE$
            \item[$\triangleright$] ii) $Q: A \rightarrow BC, D \rightarrow AE$
        \end{itemize}
    \end{itemize}
\end{frame}
