...
\begin{frame}{University Database Example}
    \begin{itemize}
        ...
        \end{itemize}
        \item In the early days, database applications were built directly on top of file systems
    \end{itemize}
\end{frame}
...
\begin{frame}{Course Outline}
    \begin{center}
        ...
        \begin{tabular}{|l|l|}
        \hline
        \textbf{Week No.} & \textbf{Topics} \\ \hline
        Week 1 & Course Overview; Introduction \\ \hline
        Week 2 & Basic Structured Query Language \\ \hline
        Week 3 & Advanced Structured Query Language \\ \hline
        Week 4 & Relational Algebra, Entity Relationship Model \\ \hline
        Week 5 & Normal Forms and Functional Dependency \\ \hline
        Week 6 & Normal Forms and Functional Dependency \\ \hline
        Week 7 & Application Development \\ \hline
        Week 8 & Storage Management \\ \hline
        Week 9 & Indexing and Hashing \\ \hline
        Week 10 & Transactions \\ \hline
        Week 11 & Backup and Recovery \\ \hline
        Week 12 & Query Optimization, Conclusion \\ \hline
        \end{tabular}
        \end{adjustbox}
    \end{center}
\end{frame}
